...
<form class="form form--add-lot container form--invalid" action="add.php" method="post"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
        ...
        <div class="form__item">
            ...
            <select id="category" name="category_id">
                ...
                <option value="5">Инструменты</option>
    ...
    <div class="form__item form__item--file">
        ...
        <div class="form__input-file">
            <input class="visually-hidden" type="file" id="lot-img" value="img" name="img">
            <label for="lot-img">
                Добавить
            </label>
        </div>
    ...
    <div class="form__container-three">
        <div class="form__item form__item--small">
            ...
            <input id="lot-rate" type="text" name="initial_price" placeholder="0">
        ...
        <div class="form__item">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="dt_end" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
