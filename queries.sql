...
INSERT INTO users
    (dt_reg, email, user_name, password, contact_info)
VALUES ('2019-11-01', 'hacker@gmail.com', 'Иванов Иван', 987654321, 'т. 9504567856');

/* Добавляем объявления, я так понмаю, автора добавляем в другую табл., а здесь связь работает, ведь там ключь первичен?  */
INSERT INTO lots
...
INSERT INTO lots
(dt_add, lot_name, description, img, initial_price, dt_end, bid_step, user_id_author, category_id)
VALUES ('2019-11-10', 'DC Ply Mens 2016/2017 Snowboard', 'бла бла бла', 'img/lot-2.jpg', 159999, '2019-11-14', 500,
        8, 15);
INSERT INTO lots
(dt_add, lot_name, description, img, initial_price, dt_end, bid_step, user_id_author, category_id)
VALUES ('2019-11-11', 'Крепления Union Contact Pro 2015 года размер L/XL', 'Все работает отлично', 'img/lot-3.jpg',
        8000, '2019-11-12', 1000, 7, 16);
INSERT INTO lots
(dt_add, lot_name, description, img, initial_price, dt_end, bid_step, user_id_author, category_id)
VALUES ('2019-11-08', 'Ботинки для сноуборда DC Mutiny Charocal', '47 размер', 'img/lot-4.jpg', 10999, '2019-11-13',
        200, 8, 17);
INSERT INTO lots
(dt_add, lot_name, description, img, initial_price, dt_end, bid_step, user_id_author, category_id)
VALUES ('2019-11-07', 'Куртка для сноуборда DC Mutiny Charocal', 'Куртка - супер!', 'img/lot-5.jpg', 7500,
        '2019-11-15', 300, 7, 18);
INSERT INTO lots
(dt_add, lot_name, description, img, initial_price, dt_end, bid_step, user_id_author, category_id)
VALUES ('2019-11-06', 'Маска Oakley Canopy', 'Хорошая маска, в идеале', 'img/lot-6.jpg', 5400, '2019-11-24', 400, 8, 20);
...
ORDER BY lots.dt_add DESC LIMIT 2;
